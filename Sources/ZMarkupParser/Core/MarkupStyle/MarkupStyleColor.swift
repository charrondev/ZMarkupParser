...
public struct MarkupStyleColor {
    ...
    public extension MarkupStyleColor {
        func getColor() -> UIColor {
            return rawColor ?? UIColor(red: CGFloat(red) / 255.0, green: CGFloat(green) / 255.0, blue: CGFloat(blue) / 255.0, alpha: alpha)
        }
    ...
    public extension MarkupStyleColor {
        func getColor() -> NSColor {
            return rawColor ?? NSColor(red: CGFloat(red) / 255.0, green: CGFloat(green) / 255.0, blue: CGFloat(blue) / 255.0, alpha: alpha)
        }
